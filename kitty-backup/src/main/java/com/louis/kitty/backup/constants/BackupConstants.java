...
public interface BackupConstants {
	...
	/** 备份目录 */
	public static final String BACKUP_FOLDER = new File(BackupConstants.class.getClassLoader().getResource("").getPath()).getParentFile().getParentFile().getAbsolutePath() + File.separator + "_backup" + File.separator;
	/** 还原目录，默认就是备份目录 */
